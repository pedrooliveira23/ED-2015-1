...
public class DLinkedLinearList implements LinearList {
	 ...
	 * 
	 * @return o indice da primeira ocorrência do elemento na lista. Retorna -1
	...
	/**
	 * Busca um nó em determinada posição da lista.
	 * 
	 * @return o nó localizado da posição index.
	 * 
	 * @throws IndexOutOfBoundsException
	 *             quando o índice fornecido não estiver entre 0 e size - 1.
	 */
